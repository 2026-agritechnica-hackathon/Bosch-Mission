    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-gray-600">
          An example that initializes a PMTiles-based MapLibre map in a SeamOS
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-gray-600">
          <code>env=&quot;dev&quot;</code> uses S3 PMTiles, and{' '}
          <code>env=&quot;prod&quot;</code> uses the device-local{' '}
          <code>/maps</code> path. Verify the actual resource path before
          deployment.
        </p>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 rounded-md bg-blue-50 p-4 text-sm text-blue-800">
          The map may fail to load on browsers without WebGL support, servers
          that do not support PMTiles Range Requests, or when the{' '}
