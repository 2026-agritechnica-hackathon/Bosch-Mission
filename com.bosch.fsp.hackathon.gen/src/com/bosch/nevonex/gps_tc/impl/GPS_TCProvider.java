...
/**
 * An implementation of the model object '<em><b>GPS_TCProvider</b></em>'.
 * @generated
 */
public class GPS_TCProvider extends EObjectImpl implements IGPS_TCProvider, IMachineProvider {
	protected EList<PropertyChangeListener> listeners;
	protected IFCALController controller;
	protected IGPS_TC gPS_TC;
	 ...
	 * @generated
	 */
	public GPS_TCProvider() {
		super();
	}

	public IGPS_TC getGPS_TC() {
		if (gPS_TC != null && ((org.eclipse.emf.ecore.EObject) gPS_TC).eIsProxy()) {
			org.eclipse.emf.ecore.InternalEObject old = (org.eclipse.emf.ecore.InternalEObject) gPS_TC;
			gPS_TC = (IGPS_TC) eResolveProxy(old);
		}
		return gPS_TC;
	}

	public IGPS_TC basicGetGPS_TC() {
		return gPS_TC;
	}

	public void setGPS_TC(IGPS_TC newGPS_TC) {
		gPS_TC = newGPS_TC;
	}

	public boolean acceptDom(String root) {
		return "gps_tc".equalsIgnoreCase(root);
	}
	...
	protected EClass eStaticClass() {
		return Gps_tcPackage.Literals.GPS_TC_PROVIDER;
	}
} //GPS_TCProvider
