...
/**
 * An implementation of the model object '<em><b>Platform_ServiceProvider</b></em>'.
 * @generated
 */
public class Platform_ServiceProvider extends EObjectImpl implements IPlatform_ServiceProvider, IMachineProvider {
	protected EList<PropertyChangeListener> listeners;
	protected IFCALController controller;
	protected IPlatform_Service platform_Service;
	 ...
	 * @generated
	 */
	public Platform_ServiceProvider() {
		super();
	}

	public IPlatform_Service getPlatform_Service() {
		if (platform_Service != null && ((org.eclipse.emf.ecore.EObject) platform_Service).eIsProxy()) {
			org.eclipse.emf.ecore.InternalEObject old = (org.eclipse.emf.ecore.InternalEObject) platform_Service;
			platform_Service = (IPlatform_Service) eResolveProxy(old);
		}
		return platform_Service;
	}

	public IPlatform_Service basicGetPlatform_Service() {
		return platform_Service;
	}

	public void setPlatform_Service(IPlatform_Service newPlatform_Service) {
		platform_Service = newPlatform_Service;
	}

	public boolean acceptDom(String root) {
		return "platform_service".equalsIgnoreCase(root);
	}
	...
	protected EClass eStaticClass() {
		return Platform_servicePackage.Literals.PLATFORM_SERVICE_PROVIDER;
	}
