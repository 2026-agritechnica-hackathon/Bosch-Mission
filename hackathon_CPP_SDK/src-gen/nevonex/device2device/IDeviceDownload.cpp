/*
 * nevonex/device2device/IDeviceDownload.cpp
...
/*PROTECTED REGION ID(IDeviceDownload.cpp) START*/
...
// Default constructor
IDeviceDownload::IDeviceDownload()
{

    /*PROTECTED REGION ID(IDeviceDownload__IDeviceDownload) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
...
IDeviceDownload::~IDeviceDownload()
{
    ...
    /*PROTECTED REGION ID(IDeviceDownload__Destructor) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
