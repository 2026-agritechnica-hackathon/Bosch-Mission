...
// Default constructor
IgnitionStateListener::IgnitionStateListener() : m_mainController(0)
{
...
::AppMain::MainController_ptr IgnitionStateListener::getMainController() const
{
    return m_mainController;
}

void IgnitionStateListener::setMainController(
